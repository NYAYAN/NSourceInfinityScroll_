(function () {
    ...
    var loadPageNumber = pContainerElem.getAttribute('load-page');
    var loadPageCounter = pContainerElem.getAttribute('load-page-counter');
    // var $ = (s, d = document) function(){} Array.prototype.slice.call(d.querySelectorAll(s));
    ...
    var getPageService = function (scrollWay, url) {
        ...
        // controlCallWichPage(false);

        lockRequest = true;
        console.log({ 'callPageNumber': callPageNumber })
    ...
    var processPagination = function (response, pageNumber, scrollWay) {
        // controlCallWichPage(lockRequest);
        ...
        if (scrollWay === "UP") {
            ...
            document.querySelector('html').scrollTop = productList[0].end + productOffsetHeight;
        }
    ...
    var hasScrollBar = function () {
        ...
        return elem.scrollHeight > window.innerHeight;
    }
    ...
    function onLoadProductList() {
        var allProducts = document.querySelectorAll('.product');
        allProducts = setPageNumberForElements(allProducts, pContainerElem.getAttribute('load-page'));
        productList.push(
            {
    ...
    //
    //if (parseInt(loadPage) > 0) {
    //    document.querySelector('html').scrollTop = productList[0].end + productList[0].offsetHeight;
    //}
})();